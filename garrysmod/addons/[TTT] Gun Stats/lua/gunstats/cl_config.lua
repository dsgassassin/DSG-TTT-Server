...
GS.StatColors = {
	["VERY LOW"] 	= Color( 0, 155, 0 ),
	["LOW"] 		= Color( 0, 255, 0 ),
	["HIGH"]		= Color( 255, 100, 0 ),
	["VERY HIGH"]	= Color( 255, 0, 0 ),

	["AVERAGE"]		= Color( 255, 255, 0 ),

	["VERY GOOD"] 	= Color( 0, 155, 0 ),
	["GOOD"] 		= Color( 0, 255, 0 ),
	["BAD"] 		= Color( 255, 100, 0 ),
	["VERY BAD"]	= Color( 255, 0, 0 ),
}
