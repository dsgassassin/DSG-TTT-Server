...
function PANEL:Init()
   ...
   self.Label:SetFont("midnight_font_12")
   self.Label:SetColor(Color(110, 110, 110))
   
   self:SetMin(0)
   self:SetMax(1000)
   self:SetValue(253)
   self:SetColor(midnight_ui.panel.top_dark)
end
...
function PANEL:Paint()
   ...
   surface.DrawRect(0, 0, Width * fDelta, self:GetTall())
end
